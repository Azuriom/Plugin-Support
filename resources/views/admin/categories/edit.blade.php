    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="{{ route('support.admin.categories.update', $category) }}" method="POST">
                ...
                <a href="{{ route('support.admin.categories.destroy', $category) }}" class="btn btn-danger" data-confirm="delete"><i class="fas fa-trash"></i> {{ trans('messages.actions.delete') }}</a>
            </form>
        </div>
    </div>
@endsection
